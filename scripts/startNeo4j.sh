...
if should_use_existing_neo4j; then
    ...
    echo "startNeo4j: ❌ Nenhuma instância Neo4j existente detectada"
    echo "startNeo4j: Iniciando instância local do Neo4j"



    echo "startNeo4j: Procedendo com inicialização da instância local..."
